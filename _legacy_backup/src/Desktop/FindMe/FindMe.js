...
const FindMe = () => {
  const { isFindActive, setIsFindActive, taskparicons, setTaskparicons } =
    useGlopalContext()
    ...
    >
      <div className='header'>
        <div className='headerbuttons'>
          <button
            ...
            onClick={() => setIsFindActive(false)}
          >
            <FaRegWindowRestore />
          </button>
          <button className=' heder-icon' onClick={() => closeFindmelWindow()}>
            <FaTimes />
          </button>
        </div>
      </div>
      ...
      <div className='map-container'>
        ...
        >
          ...
          />
          <Circle
            center={[30.5852132, 31.4994808]}
            pathOptions={fillBlueOptions}
            radius={10000}
          />
          <Circle
            center={[30.3062216, 31.742574]}
            pathOptions={fillBlueOptions}
            radius={10000}
          />
          <Marker position={[30.04442, 31.235712]}>
            <Popup>
              I Can Work in Cairo <br />
              <br />
              <div className='popup-image-container'>
                <img
                  className='popubImage'
                  src='https://images.kidzapp.com/media/CACHE/images/venues/b6380a06-56bf-11e9-b41b-960e731c160b/e37b6dbcc6fd5e39139aeeb4f4ca8b44.jpg'
                  alt='Zagazig'
                />
              </div>
            </Popup>
          ...
          <Marker position={[30.5852132, 31.4994808]}>
            <Popup>
              I can work in Zagazig <br />
              <br />
              <div className='popup-image-container'>
                <img
                  className='popubImage'
                  src='https://i.pinimg.com/originals/95/70/47/957047ca36228305c5c5f3c8127455da.png'
                  alt='Zagazig'
                />
              </div>
            </Popup>
          ...
          <Marker position={[30.3062216, 31.742574]}>
            <Popup>
              ...
              <div className='popup-image-container'>
                <img
                  className='popubImage'
                  src='https://media.gemini.media/img/large/2019/10/16/2019_10_16_9_29_39_560.jpg'
                  alt='Zagazig'
                />
              </div>
            </Popup>
