...
// },[])
 ...
 value ={{
  ...
  taskparicons , setTaskparicons ,
  isPortfolioActive , setIsPortfolioActive ,
  isPersonalActive , setIsPersonalActive ,
  isContactActive , setIsContactActive ,
  isSkillsActive , setIsSkillsActive ,
  isFindActive , setIsFindActive , result ,
  activeFromTaskBar , windowOpen ,
  IconShow,
  isSubmenuActive ,setIsSubmenuActive  , openSubmenu , location  ,submenu ,closeFromSubmenu , data
